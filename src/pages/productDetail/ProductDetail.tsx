...
import { exchangeMenony, generateNameId, getIdFromNameId, rateSale } from 'src/utils/utils'
          ...
          <div className='grid grid-cols-1 lg:grid-cols-10 lg:gap-4'>
            <div className='col-span-4'>
              ...
              <div className='relative py-3'>
                ...
                <button className='absolute right-0 top-2/4 -translate-y-2/4 bg-gray-300 py-4' onClick={increaseImage}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
            ...
            <div className='px-5 lg:col-span-6'>
              ...
              <div className='flex items-center gap-6 bg-slate-100 px-7 py-10'>
                ...
                <p className='bg-red-500 p-1 text-base font-semibold text-white'>
                  {rateSale(Number(productdetail?.data.price_before_discount), Number(productdetail?.data.price))} GIẢM
                </p>
              </div>
